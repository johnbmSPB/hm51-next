...
const plans = [
  ["Стартовый", "Бесплатно", "Для знакомства", ["Тестовый период 7 дней", "Windows-программа", "Одна команда"]],
  ["Персональный", "Бесплатно весь год", "Популярный", ["Одна команда", "Полный функционал", "Техническая поддержка"]],
  ["Клубный", "Бесплатно весь год", "Для клуба", ["До 5 команд", "Единое управление", "Техническая поддержка"]],
];
