...
export default function LandingPage() {
  return (
    <main className="landing-page">
      ...
      <footer id="contacts"><a className="brand footer-brand" href="#top"><img src="/xm-logo.svg?v=5" alt="Логотип XM 5.1" className="brand-logo"/><span><strong>XM 5.1</strong><small>ХОККЕЙНЫЙ МЕНЕДЖЕР</small></span></a><div className="footer-links"><span>ООО «КОДБЕРРИ»</span><a href="mailto:office@codberry.ru">office@codberry.ru</a><a href="tel:+79581745943">+7 (958) 174-59-43</a><a href={PRIVACY_POLICY_URL}>Политика обработки персональных данных</a><span>© ООО «КОДБЕРРИ», 2026</span></div><a className="codberry" href="https://www.codberry.ru" target="_blank" rel="noopener noreferrer"><small>Разработка и поддержка</small><strong>Codberry</strong></a></footer>
    </main>
  );
}
