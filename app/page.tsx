...
const PHL_URL = "https://phl3x3.join.hockey/";
  ...
  return (
    <main className="landing-page">
      ...
      <header className="site-header">
        ...
        <nav className="desktop-nav"><a href="#phl">ПХЛ</a><a href="#features">Возможности</a><a href="#roles">Роли</a><a href="#admin-workflow">Администраторам</a><a href="#members-workflow">Участникам</a><a href="#arenas">Аренам</a><a href="#pricing">Тарифы</a><a href={PRIVACY_POLICY_URL}>Политика</a></nav>
      ...
      <section className="phl-partnership" id="phl"><div className="phl-visual"><div className="phl-logo-mark">ПХЛ</div><strong>СКОРО<br/>ОТКРЫТИЕ!</strong><span>Питерская хоккейная лига</span></div><div className="phl-content"><p className="eyebrow">XM 5.1 × Питерская хоккейная лига</p><h2>Цифровое партнёрство для команд ПХЛ</h2><p className="phl-lead">XM 5.1 и Питерская хоккейная лига объединяют турнир и ежедневную жизнь команды в одной цифровой системе.</p><div className="phl-benefits"><article><strong>Матчи ПХЛ в календаре</strong><span>Расписание, стадион, соперник и важные изменения всегда под рукой.</span></article><article><strong>Таблицы и статистика</strong><span>Результаты, турнирное положение, команды и игроки — в разделе лиги.</span></article><article><strong>Заявки и составы</strong><span>Удобная работа администраторов и тренеров без лишних таблиц и чатов.</span></article><article><strong>Оперативные уведомления</strong><span>Новости турнира и изменения по матчам сразу получают участники команд.</span></article></div><div className="phl-actions"><a className="button button-phl" href={PHL_URL} target="_blank" rel="noopener noreferrer">Открыть сайт ПХЛ</a><a className="phl-text-link" href="#pricing">Подключить команду →</a></div></div></section>
