import { formatHourMinute } from "../../lib/timeDisplay";
...
function normalizeGame(game: any) {
  return {
    ...
    hm51_time: formatHourMinute(game.GAME_TIME),
    hm51_title:
...
function normalizeTraining(training: any) {
  return {
    ...
    hm51_time: formatHourMinute(training.TRAINING_TIME),
    ...
    hm51_duration: formatHourMinute(training.DURATION),
    hm51_attendance: "",
    hm51_member_id: "",
  };
}
